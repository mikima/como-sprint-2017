...
for(var place in tree) {
        ...
        text.content = place;
        console.log(place);
        var q = new QuantumTree(totalx, totaly, tree[place], place);
...
function QuantumTree(_x, _y, _objects, _name){
        ...
        this.size = hNum * (itemSize + padding) + padding;
        this.height = vNum * (itemSize + padding) + padding;
        ...
        //draw the items
        var xpos = _x + padding + itemSize/2;
        var ypos = _y + padding + itemSize/2;
        for(var oname in _objects) {
                ...
                if(obj.type == 'ricevuta') {
                        ...
                        // var ratio = 1.2;
                        // var c = new Path.RegularPolygon(new Point(xpos, ypos), 3, itemSize/2*ratio);
                        // 
                        var c = new Path();
